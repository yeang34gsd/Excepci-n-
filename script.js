...
function initializeCommentBox(imageId) {
  ...
  // Inicializar CommentBox con el project ID y la URL específica para esta imagen
  commentBox('5667233363656704-proj', {
    className: 'commentbox-custom',
    tlc: 'es',
    backgroundColor: document.body.classList.contains('dark-mode') ? '#1e1e1e' : '#ffffff',
    textColor: document.body.classList.contains('dark-mode') ? '#f5f5f5' : '#333333',
    creatorText: `Comentar en imagen ${imageId}`,
    placeholderText: 'Escribe tu comentario aquí...'
  });
}
